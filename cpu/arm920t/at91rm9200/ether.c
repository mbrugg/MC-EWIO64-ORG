...
#if (AT91C_MASTER_CLOCK <= 20000000)
	p_mac->EMAC_CFG |= AT91C_EMAC_CLK_HCLK_8;
#elif (AT91C_MASTER_CLOCK <= 40000000)
	p_mac->EMAC_CFG |= AT91C_EMAC_CLK_HCLK_16;
#elif (AT91C_MASTER_CLOCK <= 80000000)
	p_mac->EMAC_CFG |= AT91C_EMAC_CLK_HCLK_32;
#else
		...
		unsigned char reg, unsigned short * value)
{
	...
	at91rm9200_EmacReadPhy (p_mac, addr, reg, value);
...
{
	at91rm9200_EmacEnableMDIO (p_mac);
	at91rm9200_EmacWritePhy (p_mac, addr, reg, &value);
	at91rm9200_EmacDisableMDIO (p_mac);
	return 0;
}
