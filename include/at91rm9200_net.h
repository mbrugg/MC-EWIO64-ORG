...
UCHAR at91rm9200_EmacReadPhy(AT91PS_EMAC p_mac, unsigned char phyadd, 
			unsigned char regadd, unsigned short *pInput);
UCHAR at91rm9200_EmacWritePhy(AT91PS_EMAC p_mac, unsigned char phyadd, 
			unsigned char regadd, unsigned short *pOutput);
