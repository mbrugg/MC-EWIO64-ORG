 ...
 *
 * Configuation settings for the MC-WEBIO-ARM board.
 *
...
#define CONFIG_MCWEBIO		1	/* on a MC-WEBIO-ARM board		*/
...
#define SDRC_CR_VAL	0x2191415A /* set up the SDRAM 128 MByte*/
...
#define PHYS_SDRAM_SIZE		0x8000000  /* 128 megs */
...
#define CFG_ETH_KS8xx1 1 /* Micrel Phy */
...
#define CFG_FLASH_CFI_DRIVER_MC	1	/* use MCWebio cfi driver	*/
#ifndef CFG_FLASH_CFI_DRIVER_MC	
